...
## Installation (Blender 3.1)
Download this [repository](https://github.com/williamchange/node_tabber/archive/refs/heads/31.zip) and install from Blender's preferences, just like any other add-on (no need to unzip)