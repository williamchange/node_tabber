...
## Installation
Download this [repository(3.3 branch)](https://github.com/williamchange/node_tabber/archive/refs/heads/33.zip) and install from Blender's preferences, just like any other add-on (no need to unzip)