...
def draw_keyboard_shorcuts(pref_data, layout, context, toggle_idname, keymap_spacing=0.15, starting_indent_level=1):
    ...
    for km, kmi in get_kmi_l:
        ...
        draw_kmi([], kc, km, kmi, col, level=starting_indent_level, label=label)
